...
(() => {
    ...
    style.textContent = `
        ...
        .story-photo {
            ...
            transition: opacity .9s ease, transform 1.05s cubic-bezier(.16,.85,.25,1);
        }
        ...
        .story-photo.photo-main.is-visible {
        ...
        .story-photo.photo-small.is-visible {
        ...
        .story-photo.photo-mini.is-visible {
        ...
        .story-sticker.is-visible {
            opacity: 1;
            transform: translateY(0) rotate(0deg) scale(1);
        }

        .sticker-heart { right: 4%; top: 4px; width: 72px; height: 72px; font-size: 31px; transition-delay: .12s; }
        .sticker-star { left: 3%; top: 35%; width: 58px; height: 58px; font-size: 25px; transition-delay: .25s; }
        .sticker-note { right: 3%; top: 51%; width: 64px; height: 64px; font-size: 27px; transition-delay: .38s; }
        ...
        @media (max-width: 600px) {
            .scroll-story { min-height: 1050px; padding: 75px 0 130px; }
            .scroll-story::before { left: 50%; opacity: .35; }
            .story-heading { margin-bottom: 65px; }
            .story-heading h3 { font-size: 42px; }
            .story-grid { gap: 25px; }
            .story-gallery { height: 500px; width: 100%; }
            .story-photo.photo-main { left: 13%; top: 20px; width: 62%; height: 340px; }
            .story-photo.photo-small { right: 1%; bottom: 35px; width: 45%; height: 230px; }
            .story-photo.photo-mini { left: 0; bottom: 50px; width: 31%; height: 160px; }
            .sticker-heart { right: 2%; top: 0; width: 62px; height: 62px; }
            .sticker-star { left: 0; top: 36%; width: 52px; height: 52px; }
            .sticker-note { right: 1%; top: 52%; width: 56px; height: 56px; }
            .story-end { margin-top: 60px; }
        }

        @media (prefers-reduced-motion: reduce) {
            .story-heading, .story-copy, .story-photo, .story-sticker, .story-end {
    ...
    section.innerHTML = `
        <div class="story-heading reveal-scroll">
        ...
        <div class="story-grid">
            <div class="story-copy reveal-scroll">
                <span class="story-number">01 / MEMORY</span>
                <h4>Some moments<br>deserve to be <span>kept.</span></h4>
                <p>Hal sederhana bisa jadi kenangan paling berharga. Geser terus ke bawah dan biarkan setiap frame muncul satu per satu.</p>
                <span class="story-line">KEEP SCROLLING</span>
            </div>

            <div class="story-gallery">
                <div class="story-photo photo-main reveal-scroll">
                    <img src="${image}" alt="Memory moment utama">
                </div>
                <div class="story-photo photo-small reveal-scroll">
                    <img src="${image}" alt="Memory moment kedua">
                </div>
                <div class="story-photo photo-mini reveal-scroll">
                    <img src="${image}" alt="Memory moment ketiga">
                </div>
        ...
        <div class="story-end reveal-scroll">
            <strong>Dan ini baru awalnya.</strong>
    ...
    // Gentle scroll parallax for the stickers while the story is visible.
    let ticking = false;
    ...
    function parallax() {
        ...
        stickers.forEach((sticker, index) => {
            if (sticker.classList.contains('is-visible')) {
                sticker.style.translate = `0 ${offset * (index + 1) * .35}px`;
            }
        });
    }
