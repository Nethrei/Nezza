...
(() => {
    ...
    style.textContent = `
        ...
        .story-sticker.is-floating {
            animation: storyFloat 4.5s ease-in-out infinite;
        }

        .sticker-star.is-floating {
            animation-delay: -1.5s;
        }

        .sticker-note.is-floating {
    ...
    section.innerHTML = `
        <div class="story-heading">
            ...
            <p>
                Setiap bagian muncul saat kamu melewatinya — foto, kata-kata,
                dan stiker kecil yang bikin halaman terasa hidup.
            </p>
        </div>
        ...
        <div class="story-grid">
            <div class="story-copy reveal-scroll">
                ...
                <p>
                    Hal sederhana bisa jadi kenangan paling berharga. Geser terus
                    ke bawah dan biarkan setiap frame muncul satu per satu.
                </p>
    ...
    function parallax() {
        ...
        const progress = (
            window.innerHeight * .72 - rect.top
        ) / Math.max(rect.height, 1);
        const offset = Math.max(
            -18,
            Math.min(18, (progress - .5) * 34)
        );
