...
(() => {
  ...
  const ranks=[{min:0,name:"Rookie",badge:"🌱",title:"Awal yang bagus!",message:"Pemanasan selesai. Terus latihan dan kejar Master!"},{min:1000,name:"Master",badge:"🏆",title:"MASTER UNLOCKED!",message:"1000 poin! Refleksmu mulai nggak main-main!"},{min:2000,name:"Grand Master",badge:"👑",title:"GRAND MASTER!",message:"2000 poin! Kamu sudah masuk kelas pemain serius."},{min:3000,name:"Legend",badge:"⚡",title:"LEGENDARY RUN!",message:"3000 poin! Lari sejauh ini bukan kebetulan."},{min:4000,name:"Mythic",badge:"💎",title:"MYTHIC!",message:"4000 poin! Ini sudah level yang susah dipercaya."},{min:5000,name:"Immortal",badge:"🔥",title:"IMMORTAL!",message:"5000 poin! Kamu benar-benar bertahan sejauh ini."},{min:6000,name:"Supreme",badge:"🌟",title:"SUPREME RUNNER!",message:"6000 poin! Rank tertinggi tercapai. Respect!"}];
  ...
  let running=false,animation=0,last=0,score=0,best=Number(localStorage.getItem("birthdayRunnerBest")||0),playerY=0,velocity=0,obstacleX=0,obstacleSpeed=210,birdX=0,birdY=55;
  ...
  function resetRunner(){score=0;playerY=0;velocity=0;obstacleSpeed=210;obstacleX=area.clientWidth+100;birdX=area.clientWidth+380;birdY=55;setVisuals();if(scoreText)scoreText.textContent="0";if(rankText)rankText.textContent="Rookie";}
